...
public class EncodedSwerveMotorBuilderSparkMaxTalonHybrid {
     ...
     public EncodedSwerveSparkMaxTalonHybrid build(){
          ...
          AnalogEncoder absEncoder = new AnalogEncoder(motorConfig.getanalogEncoderId()); //TODO: might need to change
          ...
          return new EncodedSwerveSparkMaxTalonHybrid(driveMotor, turnMotor, absEncoder, driveVelConvFactor, drivePosConvFactor, steerPosConvFactor);
     }
}