...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        setupPathPlanning();
        autoChooser = new AutoChooser2024(intake, drivetrain, shooter, feeder, deployer, ramp);
...
//            SmartShuffleboard.putCommand("Shooter", "Shoot", CommandUtil.logged(new Shoot(shooter)));
        ...
        if (Constants.SWERVE_DEBUG) {
            ...
            SmartShuffleboard.putCommand("Drivetrain", "Shoot And Cross", CommandUtil.logged(new ShootCrossRight(drivetrain, shooter, ramp, intake, feeder)));
        }
    }
