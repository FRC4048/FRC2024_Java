...
public class Drive extends LoggableCommand {
    ...
    public Drive(SwerveV2Drivetrain drivetrain, DoubleSupplier fwdSupplier, DoubleSupplier strSupplier, DoubleSupplier rtSupplier, Supplier<DriveMode> driveMode) {
